...
function controller() {
  const projects = (0,_projectListFactory__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
function projectFactory(name) {
  ...
  function getUrgentToDos() {
    return toDos.filter(
      (toDo) => (0,date_fns_isToday__WEBPACK_IMPORTED_MODULE_1__["default"])(toDo.getDueDate()) === true && toDo.getPriority() === 0
    );
  }
...
/* harmony import */ var _projectListFactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./projectListFactory */ "./src/projectListFactory.js");
...
/* harmony import */ var _toDoFactory__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./toDoFactory */ "./src/toDoFactory.js");
...
const control = (0,_controller__WEBPACK_IMPORTED_MODULE_3__["default"])();
